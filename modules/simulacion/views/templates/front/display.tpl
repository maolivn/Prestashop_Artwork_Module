<div style="display: none" style='padding:10px; background:#fff;'>
    <div id="simulacion_form">
        ...
        <div class="col-md-3 sections pull-right">
            <div id="control_container">
                ...
                <div class="control_group clearfix">
                    <div class="col-md-3 sections">
                        <a href="#" id="fit_width" class="fit_to"><span class="col-md-7 col-md-offset-1">{l s='Width' mod='simulacion'}</span>
                        <span class="glyphicon glyphicon-resize-horizontal col-md-4 col-md-offset-3"></span></a>
                    </div>
                    <div class="col-md-2 sections">
                        <a href="#" id="fit_center" class="fit_to"><span class="col-md-7 col-md-offset-1">{l s='Center' mod='simulacion'}</span>
                        <span class="glyphicon glyphicon-screenshot col-md-4 col-md-offset-3"></span></a>
                    </div>
                    <div class="col-md-3 sections">
                        <a href="#" id="fit_height" class="fit_to"><span class="col-md-7 col-md-offset-1">{l s='Height' mod='simulacion'}</span>
                        <span class="glyphicon glyphicon-resize-vertical col-md-4 col-md-offset-3"></span></a>
                    </div>
                </div>
